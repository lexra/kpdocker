...
```python
m = ktc.onnx_optimizer.keras2onnx_flow(keras_model_path='yolov3-tiny.h5', optimize=0, input_shape=[1,416,416,3])
m = ktc.onnx_optimizer.onnx2onnx_flow(m)
```

#### 3.4.1 def keras2onnx_flow(keras_model_path: str, optimize: int=0, input_shape: List=None) -> onnx.ModelProto:
