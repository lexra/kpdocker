...
CLASSES = int(darknetKeyValue(CWD + NAME + '.cfg', 'classes'))
CHANNELS = int(darknetKeyValue(CWD + NAME + '.cfg', 'channels'))
WIDTH = int(darknetKeyValue(CWD + NAME + '.cfg', 'width'))
HEIGHT = int(darknetKeyValue(CWD + NAME + '.cfg', 'height'))
